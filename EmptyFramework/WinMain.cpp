...
cApp::cApp()
{
	...
	m_Width = 640;
	m_Height = 480;
	_tcscpy(m_Class, TEXT("AniFramework"));
	_tcscpy(m_Caption, TEXT("AniFramework by Pf_D"));
}
...
BOOL cApp::Init()
{
	...
	m_pMesh->OnCreate(m_Graphics.GetDeviceCOM(), TEXT("emr.x"));
	...
	// 设置投影矩阵
	m_Graphics.SetPerspective(D3DX_PI/4, m_Width/m_Height, 1.0f, 100.0f);
